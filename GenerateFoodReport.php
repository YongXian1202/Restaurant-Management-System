...
<form action="GenerateFoodReport.php" method="POST">
...
$sql = "SELECT order_item.Item_ID, order_item.Item_Name, order_item.Price, SUM(order_item.Quantity) AS Total_Quantity, (SUM(order_item.Quantity*order_item.Price)) AS Total_Amount, MONTH(orders.Date) As Month FROM order_item, orders WHERE order_item.Order_ID = orders.Order_ID GROUP BY order_item.Item_ID";
$result=mysqli_query($conn, $sql);
