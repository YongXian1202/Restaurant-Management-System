        ...
        <div class="container">
            <div class="row g-0">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <h1 class="fw-bold py-3">Please Answer The Following</h1>
                    ...
                    <form action="verifyUser.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                ...
                                <input type="email" class="form-control my-3 p-3" name = "SecurityQs1" placeholder="Enter Answer">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                ...
                                <input type="email" class="form-control my-3 p-3" name = "SecurityQs2" placeholder="Enter Answer">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                ...
                                <input type="email" class="form-control my-3 p-3" name = "SecurityQs3" placeholder="Enter Answer">
