		...
		<form action="ReceiveOrderFormat.php" method="post">
			<table cellpadding="15">
				<tr>
					...
					<td class="conlanfirm"><a href="TableOrder.php"><input type="button" value="Back"></a></td>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td style="text-align:center;"><a href="FoodOrder.php?action=remove&id=<?php echo $item["ordered_code"]; ?>" class="btnRemoveAction"><img src="icon-delete.jpeg" alt="Remove Item" /></a></td>
						</tr>
					<?php
